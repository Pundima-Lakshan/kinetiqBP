...
export const _Dashboard = () => {
  return (
    <ContainerBox style={{ backgroundColor: '#eceff1', overflowY: 'auto' }}>
      <div style={{ display: 'flex', flexDirection: 'row' }}>
        <AnalysisChart type="card" title="count" description="some description" value={34} cardActionCallback={() => window.alert('clicked')} />
      </div>
      <div style={{ display: 'flex', flexDirection: 'row' }}>
        <AnalysisChart
          type="gauge"
          ...
          value={43}
          text="43/100"
          cardActionCallback={() => window.alert('c')}
        />
      </div>
      <div>
        <AnalysisChart
