...
declare module '@mui/material/styles/createPalette' {
  ...
  // @ts-expect-error this is a module augmentation so duplicated type will be found
...
// @ts-expect-error provided from demo application missing in type definitions
