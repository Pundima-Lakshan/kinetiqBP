...
import { brand, gray } from '../theme-primitives.ts';
...
export const navigationCustomizations: Components<Theme> = {
  ...
  MuiSelect: {
    defaultProps: {
      ...
      IconComponent: forwardRef<SVGSVGElement, SvgIconProps>((props, ref) => <UnfoldMoreRoundedIcon fontSize="small" {...props} ref={ref} />),
    },
    styleOverrides: {
      root: ({ theme }) => ({
        borderRadius: theme.shape.borderRadius,
